...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/day-off-manage-approve-head.css">
...
$_SESSION['card_id'] = isset($_SESSION['card_id']) ? '123123' : '';  // ตรวจสอบว่ามีค่าหรือไม่
...
if (!empty($_SESSION["card_id"])) {
    ...
    if (sqlsrv_has_rows($sql_card_id)) {
        ...
        employee.employee_email AS employee_employee_email,
...
function confirm() {
    swal.fire({
        html: '<div style="font-weight: bold; font-size: 4vw;">อนุมัติสำเร็จ</div><br>' +
        ...
        if (result.isConfirmed) {
            // AJAX request
            $.ajax({
                url: '../processing/process_dayoff_approve.php?id=<?php echo $id; ?>',
...
function cancel() {
    swal.fire({
        html: '<div style="font-weight: bold; font-size: 4vw;">ไม่อนุมัติคำขอนี้</div><br>' +
...
<body>
                                    ...
                                    <form>
                                        <section>
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <div class="dropdown">
                                                    <div class="btn btn-primary status" onclick="confirm()">อนุมัติ
                                                    </div>
                                                    <div class="btn btn-danger status" onclick="cancel()">ปฏิเสธ</div>
                                                </div>
                                            </div>
                                        </section>
                                    </form>
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="button">
                <div class="submit">
                    <input type="submit" value="อนุมัติ" onclick="confirm('')" class="btnConfirm">
                </div>
                <div class="reject">
                    <input type="submit" value="ไม่อนุมัติ" onclick="cancel('')" class="btnReject">
                </div>
            </div>
        </div>
    </div>
