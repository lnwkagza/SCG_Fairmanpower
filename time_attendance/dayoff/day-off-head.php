...
include ("../processing/update_dayoff.php");
?>

<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/day-off-head.css">
...
if (isset ($_SESSION['card_id'])) {
    ...
    $dayoff_set_stmt = sqlsrv_prepare($conn, $select_dayoff_set, array(&$id));
    ...
    $params = array($selectedMonth, $selectedYear, $id);
    ...
    // First query
    $sql = "
    SELECT card_id, prefix_thai, firstname_thai, lastname_thai, employee_email, employee_image
    FROM employee
    ...
    WHERE MONTH(date) = ? AND YEAR(date) = ? AND cost_center_organization_id = (SELECT cost_center_organization_id
                                        FROM employee
                                        WHERE card_id = ? ) ORDER BY date ASC";
    $params = array($selectedMonth, $selectedYear,$id);
...
<script>
    ...
    function search_period() {
        var dmonth = document.getElementById('desktop-month').value;
        var dyear = document.getElementById('desktop-year').value;

        if (dmonth === 'none' || dyear === 'none') {
            alert('โปรดเลือกทุกฟิลด์ในฟอร์ม');
            return false;
        }
                                    ...
                                    <div class="pt-3 pb-3">
                                        <div class="row1">
                                            <section>
                                                ...
                                                <hr>
                                                <form class="select-time" method="post"
                                                    onsubmit="return search_period()">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label>ปี:</label>
                                                                <select name="year" class="form-control custom-select"
                                                                    id="desktop-year" required>
                                                                    ...
                                                                    <td class="employee">
                                                                        <div class="row">
                                                                            <div
                                                                                ...
                                                                                <img src="<?php echo (!empty ($section['employee_image'])) ? '../../admin/uploads_img/' . $section['employee_image'] : '../IMG/user.png'; ?>"
                                                                                    class="border-radius-100 shadow"
                                                                                    width="40" height="40" alt="">
                                                                            </div>
                                                                            <div>
                                                                                <b>
                                                                                    <?php echo $section['prefix_thai'] . $section['firstname_thai'] . ' ' . $section['lastname_thai']; ?>
                                                                                </b><br><a class="text-primary">
                                                                                    <?php echo $section['employee_email'] ?>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                        ...
                                                                        <?php if ($section['card_id'] == $info['card_id']): ?>
                                                                            <td style="user-select:none;">
                                                                                ...
                                                                                if ($info['is_day_off'] == 'Yes') {
                                                                                    ...
                                                                                    echo '<span class="show-daywork">วันทำงาน</span>';
                                                                                }
                                                                                ?>
                                                                            </td>
                                                                            <?php $found = true; ?>
                ...
                <div class="btn-top-3">
                    <div class="btn-1">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-tradition-head.php'"><img
                                    src="../IMG/day-off.png" alt=""></button>
                        </div>
                        <span>วันหยุด<br>ตามประเพณีนิยม</span>
                    </div>
                    <div class="btn-2">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-change-head.php'"><img
                                    src="../IMG/change.png" alt=""></button>
                        </div>
                        <span>ขอเปลี่ยน<br>รูปแบบวันหยุด</span>
                    </div>
                    <div class="btn-3">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-change-history-head.php'"><img
                                    src="../IMG/dayoff.png" alt=""></button>
                        </div>
                        <span>ประวัติการ<br>ขอเปลี่ยนวันหยุด</span>
                    </div>
                </div>
