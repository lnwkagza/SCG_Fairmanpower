...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/day-off-tradition-admin.css">
...
<body>
    ...
    <div style="display:none;" id="Content" class="animate-bottom">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="title">
                                        <h2>วันหยุดตามประเพณีประจำปี <?= $datethai; ?></h2>
                                    </div>
                                ...
                                <div class="card-box pd-30 pt-10 height-100-p">
                                    <div class="bar">
                                        <div class="button-add">
                                            <a href="day-off-fix-tradition-admin.php">
                                                <i class="fa-solid fa-circle-plus" style="color: #ffffff;"></i>
                                                กำหนดวันหยุดตามประเพณี
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="mobile">
            ...
            <div class="add-day-tradition" onclick="location.href='day-off-fix-tradition-admin.php'">
                <img src="../IMG/add.png" alt="">
                <span>กำหนดวันหยุดตามประเพณี</span>
            </div>
            <div class="container">
                <div class="display-topic">
                    <span>วันหยุดตามประเพณีนิยม ประจำปี <?= $datethai; ?></span>
                </div>
                        ...
                        ?>
                            <div class="show-detail-day">
                                <div class="container-detail">
                                    <span class="number"><?php echo (new DateTime($row['date']->format("Y-m-d")))->format("d"); ?></span>
                                    <span class="day"><?php echo $thaiAbbreviation; ?></span>
