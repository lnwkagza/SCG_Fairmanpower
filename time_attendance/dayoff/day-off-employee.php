...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/day-off-employee.css">
...
if (isset($_SESSION['card_id'])) {
    ...
    // update_shift($selectedYear, $selectedMonth, $_SESSION['card_id']);
    ...
    $thaiMonth = strtr($selectedMonth, $englishMonths);

    // update_shift($selectedYear, $selectedMonth, $card_id);
    ...
    WHERE MONTH(date) = ? AND YEAR(date) = ? ORDER BY date ASC";
    $params = array($selectedMonth, $selectedYear);
                                                            ...
                                                            <tr>
                                                                <td class="employee">
                                                                    <div class="row">
                                                                        ...
                                                                        <div>
                                                                            <b><?php echo $section['prefix_thai'] . $section['firstname_thai'] . ' ' . $section['lastname_thai']; ?></b><br><a
                                                                                class="text-primary"><?php echo $section['employee_email'] ?></a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                ...
                <div class="btn-top-3">
                    <div class="btn-1">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-tradition-employee.php'"><img
                    ...
                    <div class="btn-2">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-change-employee.php'"><img
                    ...
                    <div class="btn-3">
                        <div class="display-icon">
                            <button onclick="window.location.href='day-off-change-history-employee.php'"><img
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (!$found) :
                                                        ...
                                                        $endline = new DateTime($statDateline->format('Y-m-t'));
                                                        while ($statDateline <= $endline) : ?>
                                        <!-- <td><span class="show-daywork"><img class="img-work" src="../IMG/mark.png" alt=""></span></td> -->
