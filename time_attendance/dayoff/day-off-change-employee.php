...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/day-off-change-employee.css">
...
<script type="text/javascript">
    ...
    function day_off_change_confirm() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = '../processing/process_dayoff_working_Request.php';
                form.method = 'POST';
                form.submit();
            }
        });
    ...
    function day_off_change_cancel() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "day-off-employee.php";
            }
        });
    }
</script>
