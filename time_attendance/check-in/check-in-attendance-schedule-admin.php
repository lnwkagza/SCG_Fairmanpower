...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/check-in-attendance-schedule.css">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php else : ?>
                                                            <td>
                                                                <div>
                                                                    <div class="shift" onclick="window.location.href='../shift/shift-progress-step4-admin.php.?date=<?php echo $formatted_date; ?>'" title="สลับกะ">
                                ...
                                <div class="display-status">
                                    ...
                                    <div class="button-action">
                                        ...
                                        <?php else : ?>
                                            ...
                                            <a id="shift-button" href="../shift/shift-progress-step4-admin.php.?date=<?php echo $formatted_date; ?>">สลับกะ</a>
