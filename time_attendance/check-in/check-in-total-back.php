...
// Prepare statements
$check_inout_stmt = sqlsrv_prepare($conn, $select_check_inout_Query, array(&$_SESSION["card_id"], &$formatted_date));
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                            <div class="card-box pd-30 pt-10 height-100-p">
                                <div class="bar">
                                    ...
                                    <div class="count">
                                        <input type="text" value="<?php echo $_SESSION['countBack']; ?>" readonly>
                                    </div>
                                    <label>ครั้ง</label>
                                </div>
