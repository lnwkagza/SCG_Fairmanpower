...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                            <div class="card-box pd-30 pt-10 height-100-p">
                                <div class="bar">
                                    <label for="">จำนวนการเข้างานสายในปีนี้</label>
                                    <div class="count">
                                        <input type="text" value="<?php echo $_SESSION['countMiss']; ?>" readonly>
                                    </div>
                                    <label>ครั้ง</label>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($date_range as $date) {
                                                ...
                                                if (
                                                    ...
                                                    if ($absence_record_result) {
                                                        ...
                                                        if ($time_in <= $time_in_set && $time_out >= $time_out_set) {
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td style="color: #9747FF;"><?php echo $status; ?></td>
                                                        </tr>
                                            <?php
                                                    }
                                                }
    ...
    <div class="mobile">
        ...
        <div class="navbar">
            <div class="div-span">
                <span>รายละเอียดการเข้างานสาย</span>
            </div>
        </div>

        <div class="topic-top">
            <span>จำนวนการมาสายในเดือนนี้</span>
            <input type="text" placeholder="<?php echo $countMiss; ?>">
            <span>ครั้ง</span>
        </div>
        ...
        <div class="display-month-totalDay">
            ...
            ?>
                        <div class="detailMissing">
                            ...
                            <span style="color: #FF9922;"><?php echo $status; ?></span>
                        </div>
        ...
        <script>
            function changeStatusColor() {
                var detailMissingElement = document.querySelector(
                    ".detailMissing span[style='color: #FF9922;']");
