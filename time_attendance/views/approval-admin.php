...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/approval-admin.css">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="name">
                                                            <div class="row">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a
                                                                        class="text-primary"><?= $row['employee_email'] ?></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="action"><button class="btn btn-info"
                                                                onclick="window.location.href='shift-detail-manage-employee.php?sub_team_id=<?= $row['sub_team_id']; ?>'">รายละเอียด</button>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            ...
                                            <table id="table2" class="table table-striped" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action"><button class="btn btn-info"
                                                                onclick="window.location.href='shift-detail-change-employee.php?shift_change_id=<?= $row['shift_change_id']; ?>'">รายละเอียด</button>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            ...
                                            <table id="table3" class="table table-striped" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action"><button class="btn btn-info"
                                                                onclick="window.location.href='shift-detail-switch-employee.php?shift_switch_id=<?= $row['shift_switch_id']; ?>'">รายละเอียด</button>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            ...
                                            <table id="table4" class="table table-striped" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action"><button class="btn btn-info"
                                                                onclick="window.location.href='shift-detail-add-employee.php?shift_add_id=<?= $row['shift_add_id']; ?>'">รายละเอียด</button>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            ...
                                            <table id="table5" class="table table-striped" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action"><button class="btn btn-info"
                                                                onclick="window.location.href='shift-detail-lock-employee.php?shift_lock_id=<?= $row['shift_lock_id']; ?>'">รายละเอียด</button>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action"><button class="detail"
                                            onclick="window.location.href='../shift/shift-detail-manage-employee.php?sub_team_id=<?= $row['sub_team_id']; ?>'">รายละเอียด</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <table id="example2" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action"><button class="detail"
                                            onclick="window.location.href='../shift/shift-detail-change-employee.php?shift_change_id=<?= $row['shift_change_id']; ?>'">รายละเอียด</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <table id="example3" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action"><button class="detail"
                                            onclick="window.location.href='../shift/shift-detail-switch-employee.php?shift_switch_id=<?= $row['shift_switch_id']; ?>'">รายละเอียด</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <table id="example4" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action"><button class="detail"
                                            onclick="window.location.href='../shift/shift-detail-add-employee.php?shift_add_id=<?= $row['shift_add_id']; ?>'">รายละเอียด</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <table id="example5" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action"><button class="detail"
                                            onclick="window.location.href='../shift/shift-detail-lock-employee.php?shift_lock_id=<?= $row['shift_lock_id']; ?>'">รายละเอียด</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
