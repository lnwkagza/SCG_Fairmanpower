...
?>
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/ot-employee.css">
                            ...
                            <div class="card-box pd-30 pt-10 height-100-p" id="box1">
                                ...
                                <div class="row">
                                    <div class="display-menu">
                                        <div>
                                            <button type="button" onclick="window.location.href='https://scgot.online/screen/employee/index.php?w1=<?= $line_id ?>'">
                                                <div><img src="../IMG/request-ot.png" alt=""></div>
                                                <div><span>ขออนุมัติ</span></div>
                                            </button>
                                        </div>
                                        <div>
                                            <button type="button" onclick="window.location.href='https://scgot.online/screen/employee/checkStatus.php?w1=<?= $line_id ?>'">
                                                <div><img src="../IMG/check-ot.png" alt=""></div>
                                                <div><span>เช็กสถานะ</span></div>
                                            </button>
                                        </div>
                                        <div>
                                            <button type="button" onclick="window.location.href='https://scgot.online/screen/employee/summarize.php?w1=<?= $line_id ?>'">
            ...
            <div class="btn-top-head">
                <div class="btn-1">
                    <div class="display-icon">
                        <button onclick="window.location.href='https://scgot.online/screen/employee/index.php?w1=<?= $line_id ?>'"><img src="../IMG/reques1.png" alt="">
                        </button>
                    </div>
                    <span>ขออนุมัติ</span>
                </div>
                <div class="btn-4">
                    <div class="display-icon">
                        <button onclick="window.location.href='https://scgot.online/screen/employee/checkStatus.php?w1=<?= $line_id ?>'"><img src="../IMG/check.png" alt=""></button>
                    </div>
                    <span>เช็กสถานะ</span>
                </div>
                <div class="btn-4">
                    <div class="display-icon">
                        <button onclick="window.location.href='https://scgot.online/screen/employee/summarize.php?w1=<?= $line_id ?>'"><img src="../IMG/sum.png" alt=""></button>
                    </div>
