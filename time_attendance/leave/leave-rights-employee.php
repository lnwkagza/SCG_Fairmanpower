...
<body>
    ...
    <div style="display:none;" id="Content" class="animate-bottom">
        ...
        <div class="mobile">
            ...
            <div class="button-3">
                <div class="step">
                    <div><a href="leave-request-employee.php"><img src="../IMG/more0.png" alt=""></a>
                    </div>
                    <span>ทำรายการลา</span>
                </div>
                <div class="step">
                    <div><a href="leave-history-employee.php"><img src="../IMG/history.png" alt=""></a>
                    </div>
                    <span>ประวัติการลา</span>
                </div>
                <div class="step">
                    <div><a href="leave-team-employee.php"><img src="../IMG/Group1.png " alt=""></a>
                    </div>
