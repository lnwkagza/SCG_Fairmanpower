...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/leave-history-admin.css">
                                        ...
                                        <table id="table1" class="table table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="leave-edit-admin.php?id='<?php echo $row['absence_record_id'] ?>'"><img
                                                                src=" ../IMG/edit.png" style="width: 30px;"></a></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                        ...
                                        <table id="table2" class="table table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="leave-edit-admin.php?id='<?php echo $row['absence_record_id'] ?>'"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center !important"><a
                                    href="leave-edit-admin.php?id='<?php echo $row['absence_record_id'] ?>'"><img
                                        src="../IMG/edit.png" style="width: 20px; height: 20px;"></a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
