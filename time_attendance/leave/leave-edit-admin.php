...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/leave-edit-admin.css">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class=" breadcrumb-item">
                                            <a href="leave-history-admin.php">ประวัติการลา</a>
                                        </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class=" form-control" type="date" name="startDate" id="desktop-start-date" value="<?php echo $row['date_start']->format('Y-m-d'); ?>" onchange="calculateLeaveday()">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="endDate">ถึงวันที่</label>
                                                                <input class="form-control" type="date" name="endDate" id="desktop-end-date" value="<?php echo $row['date_end']->format('Y-m-d'); ?>" onchange="calculateLeaveday()">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="time" id="desktop-start-time" value="<?php echo $row['time_start']->format('H:i'); ?>" name="startTime" onchange="calculateLeaveDuration()">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="endTime">ถึงเวลา</label>
                                                                <input class="form-control" type="time" id="desktop-end-time" name="endTime" value="<?php echo $row['time_end']->format('H:i'); ?>" onchange="calculateLeaveDuration()">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="request_detail" value="<?php echo $row['request_detail']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
