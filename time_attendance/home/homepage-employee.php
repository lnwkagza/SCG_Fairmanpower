...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/homepage-employee.css">
...
<script>
let personID = <?= $card_id; ?>

// btnวันหยุด
function submit_dayOff() {
    window.location.href = '../dayoff/day-off-employee.php';
}

function submit_Leave() {
    window.location.href = '../leave/leave-rights-employee.php';
}

function submit_workka() {
    window.location.href = '../shift/shift-employee.php';
}

function submit_ot() {
    window.location.href = '../ot/ot-employee.php';
}

function check_in_attendance_schedule() {
    window.location.href = '../check-in/check-in-warning.php';
}
...
function approval() {
    window.location.href = '../views/approval-employee.php';
}
...
function GPS_settings() {
    window.location.href = '../gps/employee_request_gps.php';
}
</script>
                ...
                <div class="check-in">
                    ...
                    <div class="btn-check-in">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="displayTime-qr center">
                                                    <div>
                                                        <span class="Topic" style="text-align:center;">สแกน
                                                            QR-Code
                                                            เพื่อลงชื่อ</span>
                                                    </div>
                                                    <div>
                        ...
                        <div class="btn-GPS">
                            ...
                            <button type="button" onclick="window.location.href='../gps/employee-detail-gps.php';">
                                <div><img src="../IMG/gps.png" alt=""></div>
                                <div>GPS</div>
                            </button>

                            <!-- <div class="modal fade" id="check-inout-Modal-gps" tabindex="-1" aria-labelledby="exampleModalLabel">
                                <div class="modal-dialog">
                                    <div class="containerGPS">
                                        <div class="modal-content">
                                            ...
                                            <div class="btnRequestGPS">
                                                <button onclick="GPS_settings()" type="button">
                                                    <img src="../IMG/cross-warn.png" class="custom-image">
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="displayTime-gps">
                                                    <div>
                                                        <span class="Topic" style="text-align:center;">ยืนยันการลงเวลา</span>
                                                    </div>
                                                    <div>
                                                        <span class="Time" style="text-align:center;">
                                                            <?php echo "เวลา " . $time_now . " น."; ?>
                                                ...
                                                <div class="btnGPS-check-in">
                                                    <div>
                                                        <button type="button" id="check-in-button-gps" style="background-color: #F2CB00;">ลงชื่อเข้างาน</button>
                                                        <button type="button" id="check-out-button-gps" style="background-color: #FF5643;">ลงชื่อออกงาน</button>
                                                    </div>
                                                </div>
                        ...
                        <!-- <div id="new_gps" class="btn-GPS">

                            <button type="button" data-bs-toggle="modal" data-bs-target="#overview-check-inout-Modal-gps">
                                <div><img src="../IMG/gps.png" alt=""></div>
                                <div>GPS</div>
                            </button>

                            <div class="modal fade" id="overview-check-inout-Modal-gps" tabindex="-1" aria-labelledby="exampleModalLabel">
                                <div class="modal-dialog">
                                    <div class="containerGPS">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-headerGPS">
                                                <div>
                                                    <span>การบันทึกเวลาด้วย GPS</span>
                                                </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <section class="center">
                                                    <div class="row">
                                                        ...
                                                        <h4>สถานที่บันทึกเวลาวันนี้</h4>


                                                        <span id="workType_time">รูปแบบ :</span>


                                                        <span id="workType_gps">ประเภท :</span>
                                                ...
                                                <section>
                                                    <div class="row">
                                                        <div class="col">
                                                            <button type="">เข้างาน</button>
                                                        </div>
                                                        <div class="col">
                                                            <button type="">ออกงาน</button>
                                                        </div>
                                                    </div>
                                                </section>
                            ...
                            <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Open 2 modal</button>
                                            <button class="btn btn-primary" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal" data-bs-dismiss="modal">Open 3 modal</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
