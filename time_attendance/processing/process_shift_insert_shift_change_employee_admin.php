...
$sql = "INSERT INTO shift_change
            (input_timestamp, card_id, date,  request_card_id, new_shift_id, request_detail, approve_status, approver, inspector) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
       
// Prepare the statement
$stmt = sqlsrv_prepare($conn, $sql, array(&$time_stamp, &$employeeIds, &$date, &$cardId, &$shiftType, &$detail, 'waiting', &$approve, &$inspector));
