    ...
    if (isset($_SESSION["card_id"])) {
        ...
        try {
            ...
            $query = "INSERT INTO shift_switch (
                ...
                new_shift_3, request_card_id, request_detail, approve_time, 
                approve_status, approver, inspector
            ) VALUES (
                ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
            )";
            ...
            for ($i = 1; $i <= $employeeCount; $i++) {
                ...
                $params = array(
                    ...
                    $cardId, $request_detail, $time_stamp, 'confirm',
                    $cardId, $inspector_id
                );
            ...
            sqlsrv_commit($conn);
            header("Location: ../shift/shift-progress-step4-head.php");
            exit;
        } catch (Exception $e) {
