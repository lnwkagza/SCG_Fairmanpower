...
// Prepare SQL query to update day-off request status to 'reject'
$query = "UPDATE day_off_request 
          SET approve_status = ?, approve_time = ?,inspector_status = ?, inspector_time = ? 
          WHERE day_off_req_id = ?";
$addvalues = array('reject', $time_stamp,'reject', $time_stamp, $id);
