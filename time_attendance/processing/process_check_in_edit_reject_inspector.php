...
$message = "รายการขอแก้เวลา check in ของคุณ " . $row['firstname_thai'] . ' ' . $row['lastname_thai'] . ' ได้รับการปฎิเสธ เมื่อเวลา ' . $time_stamp."https://liff.line.me/2003823996-Q0DXqyOZ";
...
echo '<script>
                alert("คุณการปฎิเสธรายการขอแก้ไขเวลาเข้างานสำเร็จ");
