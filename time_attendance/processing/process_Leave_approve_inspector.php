...
// Prepare and execute update query to confirm absence record
$query = "UPDATE absence_record 
          SET inspector_status = ?, inspector = ?, inspector_time = ? 
          WHERE absence_record_id = ?";
$addvalues = array('confirm', $card_id, $time_stamp, $id);
...
$message = "รายการขอลาของคุณ " . $row['firstname_thai'] . ' ' . $row['lastname_thai'] . ' ได้รับการตรวจสอบ เมื่อเวลา ' . $time_stamp . " ดูเพิ่มเติม: https://liff.line.me/2003823996-Q0DXqyOZ";
...
echo '<script>
        alert("คุณได้ทำการอนุมัติรายการลา");
