...
?>
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/shift-switch-head.css">
...
if (isset($_SESSION["card_id"])) {
    ...
    $select_dayoffteam = "SELECT  employee.card_id AS card_id,
    ...
    $select_shift_team = "SELECT employee.scg_employee_id AS scg_employee_id,  
        employee.prefix_thai AS prefix_thai,  
        employee.firstname_thai AS firstname_thai,  
        employee.lastname_thai AS lastname_thai, 
...
<script type="text/javascript">
    ...
    function createEmployeeForm(employeeCount) {
        var formContent =
            '<form id="myForm" action="../processing/process_shift_insert_shift_switch_employee_head.php" method="POST">' +
        ...
        formContent +=
            ...
            '<div class="content6">' +
            '<div class="inspector"><span>ผู้ตรวจสอบ</span><select name="inspector_id" id="inspector_id"><option value="">เลือกผู้ตรวจสอบ</option>' +
    ...
    function mobile_add_switchShift() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_shift_switch_employee_head.php",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_shift_switch_employee_head.php';
        form.method = 'POST';
        form.submit();
    }
...
<body>
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step3-head.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step5-head.php'">ถัดไป</button>
                    </div>
                    <div class="row">
                                                ...
                                                <div class="<?php echo "employee" . $i ?> mb-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>ทีม</label>
                                                                <input type="text" class="form-control" id="<?php echo "desktop-team" . $i ?>" style="background-color:transparent;cursor:pointer" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                <button class="btn" id="prev" onclick="location.href='shift-progress-step3-head.php'">Prev</button>
                <button class="btn" id="next" onclick="location.href='shift-progress-step5-head.php'">Next</button>
            </div>
        </div>
