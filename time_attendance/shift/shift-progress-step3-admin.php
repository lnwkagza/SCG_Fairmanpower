...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/shift-lock-admin.css">
...
<script type="text/javascript">
    function mobile_add_lockShift() {
        ...
        var popupContent =
            '<form id="myForm" action="../processing/process_shift_insert_lock_employee_admin.php" method="POST">' +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_lock_employee_admin.php",
                    data: formData,
                    processData: false,
                    contentType: false,
                });
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_lock_employee_admin.php';
        form.method = 'POST';
        form.submit();
    }
...
<body>
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-3">
                            ...
                            <div class="circle"><a href="shift-progress-step4-admin.php">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step2-admin.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step4-admin.php'">ถัดไป</button>
                    </div>
                    <div class="row">
                            ...
                            <div class="card-box pd-30 pt-10 height-100-p">
                                <div class="pt-3 pb-3">
                                    <div class="bar">
                                        ...
                                        <button id="prevMonth" onclick="javascript:location.href='?month=<?php echo $prev_month; ?>&year=<?php echo $prev_year; ?>'">
                                            <img src="
                                    ...
                                    <div class="desktop-table-container admin">
                                        <div class="desktop-table left">
                                            <table id="admin-table1" class="table stripe hover nowrap">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <div>
                                                                        <b>
                                                                            <?php echo $rs_emp['prefix_thai'] . $rs_emp['firstname_thai'] . ' ' . $rs_emp['lastname_thai']; ?>
                                                                        </b><br>
                                                                        <a class="text-primary">
                                                                            <?php echo $rs_emp['employee_email'] ?>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                        ...
                                        <div class="desktop-table right slide">
                                            <table id="admin-table2" class="table stripe hover nowrap">
                                                <thead>
                                                    <tr>
                                                        <?php
                                    ...
                                    <div class="desktop-table-container employee" style="display:none;">
                                        <div class="desktop-table left">
                                            <table id="employee-table1" class="table stripe hover nowrap">
                                                <thead>
                                                    <tr>
                                                        <th colspan="3" data-orderable="false">ข้อมูลพนักงาน
                                                        </th>
                                        ...
                                        <div class="desktop-table right slide">
                                            <table id="employee-table2" class="table stripe hover nowrap">
                                                <thead>
                                                    <tr>
                                                        <?php
                                                        for ($day = 1; $day <= date('t', strtotime("$selected_year-$selected_month-01")); $day++) {
    ...
    <div class="mobile">
            ...
            <div class="container-lock">
                <div class="container-table-team">
                    ...
                    <div class="table-shift">
                        ...
                        <div class="display-table-admin" style="display:none;">
                        ...
                        <div class="display-table-employee">
                            <div class="display-table-left">
                                <table>
                                    <thead>
                                        <tr>
        ...
        <div class="btn-action-step">
            <button class="btn" id="prev" onclick="location.href='shift-progress-step2-admin.php'">Prev</button>
            <button class="btn" id="next" onclick="location.href='shift-progress-step4-admin.php'">Next</button>
        </div>
    </div>
</body>
