...
?>
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/shift-switch-employee.css">
...
<script type="text/javascript">
    ...
    function myFunction2() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'day-off-change-history-employee.php';
            } else {
                swal("รายการที่เลือกไม่มีการเปลี่ยนแปลง");
            }
        });
    ...
    function createEmployeeForm(employeeCount) {
        var formContent =
            '<form id="myForm" action="../processing/process_shift_insert_shift_switch_employee.php" method="POST">' +
    ...
    function mobile_add_switchShift() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_shift_switch_employee.php",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_shift_switch_employee.php';
        form.method = 'POST';
        form.submit();
    }
...
<body>
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step3-employee.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step5-employee.php'">ถัดไป</button>
                    </div>
                    <div class="row">
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                <button class="btn" id="prev" onclick="location.href='shift-progress-step3-employee.php'">Prev</button>
                <button class="btn" id="next" onclick="location.href='shift-progress-step5-employee.php'">Next</button>
            </div>
        </div>
