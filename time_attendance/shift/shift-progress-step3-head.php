...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/shift-lock-head.css">
...
<script type="text/javascript">
    function mobile_add_lockShift() {
        ...
        var popupContent =
            '<form id="myForm" action="../processing/process_shift_insert_lock_employee_head.php" method="POST">' +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_lock_employee_head.php",
                    data: formData,
                    processData: false,
                    contentType: false,
                });
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_lock_employee_head.php';
        form.method = 'POST';
        form.submit();
    }
...
<body>
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step2-head.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step4-head.php'">ถัดไป</button>
                    </div>
                    <div class="row">
    ...
    <div class="mobile">
        ...
        <div class="btn-action-step">
            <button class="btn" id="prev" onclick="location.href='shift-progress-step2-head.php'">Prev</button>
            <button class="btn" id="next" onclick="location.href='shift-progress-step4-head.php'">Next</button>
        </div>
    </div>
</body>
