...
?>
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/shift-admin.css">
                                ...
                                <div class="pt-3 pb-3">
                                    <div class="bar">
                                        <div class="button-switch-table">
                                            <button id="button-switch1" style="display:none;"
                                                onclick=" switch_table('button-switch1')">ดูกะการทำงานของตัวเอง</button>
                                            <button id="button-switch2"
                                                onclick=" switch_table('button-switch2')">ดูกะการทำงานของพนักงาน</button>
                                        </div>
                                        <button id="prevMonth"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div style="margin-right: 5px;margin-left: 5px;">
                                                                    <img src="<?php echo (!empty($rs_emp['employee_image'])) ? '../IMG/' . $rs_emp['employee_image'] : '../IMG/user.png'; ?>"
                                                                        class="border-radius-100 shadow" width="40"
                                                                        height="40" alt="">
                                                                </div>
                                                                <div>
