...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/shift-request-employee.css">
...
if (isset($_SESSION["card_id"])) {
    ...
    $select_shift_add_data_query = "SELECT shift_add_id,approve_status,firstname_thai, lastname_thai, date, 
                                    ...
                                    WHERE shift_add.request_card_id = ? ORDER BY shift_add.date ASC;";
    ...
    $select_shift_change_data_query = "SELECT shift_change_id,approve_status,firstname_thai, lastname_thai, date, 
                                        ...
                                        WHERE shift_change.request_card_id =  ? ORDER BY shift_change.date ASC;";
    ...
    $select_shift_switch_data_query = "SELECT shift_switch_id,
                                        ...
                                        WHERE shift_switch.request_card_id = ? ORDER BY shift_switch.date ASC;";
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                            <div class="card-box pd-30 pt-10 height-100-p">
                                <div class="button-bar">
                                    ...
                                    <button id="btn2" class="">ล็อกเหลี่ยม</button>
                                    <button id="btn3" class="">สลับกะ</button>
                                    <button id="btn4" class="">เปลี่ยนกะ</button>
                                    <button id="btn5" class="">เพิ่มกะ</button>
                                </div>
                        ...
                        <tr>
                            <td class="status">
                                <?php // ตรวจสอบ $row['approve_status'] และแปลงเป็นข้อความที่กำหนด
                                    ...
                                    ?></td>
                            <td class="name"><?php echo $row['firstname_thai'] . ' ' . $row['lastname_thai']; ?></td>
                            <td class="date"><?php echo $row['date']->format('d-m-Y'); ?>
                            </td>
                            <td class="action"><button class="detail"
                                    onclick="window.location.href='shift-detail-change-employee.php?shift_change_id=<?= $row['shift_change_id']; ?>'">รายละเอียด</button>
                            </td>
