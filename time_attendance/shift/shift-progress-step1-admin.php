...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/shift-manage-table-admin.css">
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-1">
                            ...
                            <div class="circle"><a href="shift-progress-step2-admin.php">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="next"
                            onclick="location.href='shift-progress-step2-admin.php'">ถัดไป</button>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class=" form-group">
                                                        ...
                                                        <select class="custom-select form-control" id="desktop-adminid"
                                                            onchange="add_member()">
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                ...
                <button class="btn" id="next" onclick="location.href='shift-progress-step2-admin.php'">Next</button>
...
function TeamAdd(nameteamValue) {
    $.ajax({
        type: "POST",
        url: "../processing/process_shift_insert_addteam_admin.php",
        data: {
...
function AddTeamEmployee() {
    ...
    $.ajax({
        type: "POST",
        url: "../processing/process_shift_insert_addTeamEmployee_admin.php",
        data: {
            team: Team,
...
//desktop script
function add_member() {
    var employee = document.getElementById("desktop-adminid").value;
...
function add_team_member() {
    ...
    var des_employeeid = [];
    $('#desktop-adminid option:selected').each(function() {
