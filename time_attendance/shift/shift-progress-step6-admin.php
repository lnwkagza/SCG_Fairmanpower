...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/shift-change-admin.css">
...
<script type="text/javascript">
    function mobile_add_changeShift() {
        ...
        var popupContent =
            '<form id="myForm" action="../processing/proess_shift_insert_shift_change_employee_admin.php" method="POST">' +
            ...
            '<div class="form-control-add" name="shiftType" id="shiftType"></div>' +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_shift_change_employee_admin.php",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_shift_change_employee_admin.php';
        form.method = 'POST';
        form.submit();
    }
...
<body>
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-6">
                            ...
                            <div class="circle active"><a href="shift-progress-step5-admin.php">
                                    <span>5</span><span class="title">เปลี่ยนกะ</span></a></div>
                            <div class="circle active"><a href="shift-progress-step6-admin.php">
                                    <span>6</span><span class="title">เพิ่มกะ</span></a></div>
                        </div>
                    </div>
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step4-admin.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step6-admin.php'">ถัดไป</button>
                    </div>
                    <div class="row">
                                    ...
                                    <form id="desktop-form">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control" name="employeeid" id="desktop-employeeid" onchange="display_employee_oldshift()">
                                                        <option value="">เลือกสมาชิกในทีม</option>
                                                        <?php echo $options; ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>กะเดิม</label>
                                                    <input type="text" class="form-control" id="desktop-oldshift" style="background-color:transparent" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>กะใหม่</label>
                                                    <select class="custom-select form-control" name="shiftType" id="desktop-newshift">
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="container-progress">
                <div class="progress-container step-6">
                    ...
                    <div class="circle active"><a href="shift-progress-step5-admin.php">
                            <span>5</span><span class="title">เปลี่ยนกะ</span></a></div>
                    <div class="circle active"><a href="shift-progress-step1-admin.php">
                            <span>6</span><span class="title">เพิ่มกะ</span></a></div>
                </div>
            </div>
        ...
        <div class="btn-action-step">
            <button class="btn" id="prev" onclick="location.href='shift-progress-step4-admin.php'">Prev</button>
