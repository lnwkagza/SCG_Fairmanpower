...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/shift-change-head.css">
...
if (isset($_SESSION["card_id"])) {
    ...
    // Fetch employee data
    $id = $_SESSION["card_id"];
    $query = "SELECT card_id, prefix_thai, scg_employee_id, firstname_thai, lastname_thai, remark, day_off1, day_off2, sub_team.name AS TeamName FROM employee 
    ...
    $SELECT_approver = "SELECT card_id, prefix_thai, firstname_thai, lastname_thai FROM employee WHERE permission_id = ? and card_id != ?";
...
<script type="text/javascript">
    function mobile_add_changeShift() {
        ...
        var popupContent =
            '<form id="myForm" action="../processing/proess_shift_insert_shift_change_employee_head.php" method="POST">' +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_shift_change_employee_head.php",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_shift_change_employee_head.php';
        form.method = 'POST';
        form.submit();
    }
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step4-head.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next" onclick="location.href='shift-progress-step6-head.php'">ถัดไป</button>
                    </div>
                    <div class="row">
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                ...
                <button class="btn" id="next" onclick="location.href='shift-progress-step6-head.php'">Next</button>
            </div>
        </div>
