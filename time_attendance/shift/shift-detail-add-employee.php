...
$shiftAddId = $_GET['shift_add_id']; // Assuming you're getting the shift_change_id from a request, adjust this based on your input method (GET, POST, etc.)
...
$sql = "
    ...
    shift_add 
    INNER JOIN 
        employee ON shift_add.card_id = employee.card_id
    INNER JOIN 
        shift_type AS add_shift_type_id ON shift_add.add_shift_type_id = add_shift_type_id.shift_type_id
    LEFT JOIN 
        employee AS inspector ON shift_add.inspector = inspector.card_id
    LEFT JOIN 
        employee AS approver ON shift_add.approver = approver.card_id
    WHERE 
    shift_add.shift_add_id = ?"; // Use parameterized query to avoid SQL injection

// Prepare and bind parameters
$params = array($shiftAddId);
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="title">
                                    <h2>รายละเอียดคำขออนุมัติการขอเพิ่มกะ</h2>
                                </div>
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page" style="cursor:default;">
                                            รายละเอียดคำขออนุมัติการขอเพิ่มกะ
                                        </li>
                                    </ol>
                                </nav>
                            </div>
        ...
        <div class="container">
            ...
            <div class="display-detail">
                ...
                <div class="display-shift">
                    <div class="shift-add">
                        <span>กะที่เพิ่ม</span>
                        <div class="add">
                            <span><?= $shiftTypeMapping[$row['add_shift_type_id']] ?></span>
                        </div>
                    </div>
                </div>
                <div class="reason">
