...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/head/shift-manage-table-head.css">
...
function mobile_add_team() {
    Swal.fire({
        html: '<div class="topic">กำหนดชื่อทีมที่ต้องการเพิ่ม</div>' +
            '<div class="dateFix"><input id="nameday" type="text" style="padding: 2.5vw;"></div>',
        padding: '2em',
...
function mobile_add_team_submit() {
    Swal.fire({
        html: '<div style="font-weight: bold; font-size: 4vw;">ยืนยันการกำหนดทีมหรือไม่</div><br>' +
            '<img src="../IMG/question 1.png" style="width:15vw; margin-top: -10px; height:15vw;"></img>',
        padding: '2em',
...
function mobile_add_team_success() {
    Swal.fire({
        html: '<div style="font-weight: bold; font-size: 4vw;">เพิ่มทีมสำเร็จ</div><br>' +
            '<img src="../IMG/check1.png" style="width:20vw; margin-top: 2px;  height:20vw;"></img>',
        padding: '2em',
...
function mobile_edit_team_submit() {
    Swal.fire({
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-1">
                            ...
                            <div class="circle"><a href="shift-progress-step2-head.php">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="next"
                            onclick="location.href='shift-progress-step2-head.php'">ถัดไป</button>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class=" form-group">
                                                        ...
                                                        <select class="custom-select form-control" id="desktop-headid"
                                                            onchange="add_member()">
    ...
    <div class=" mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                ...
                <button class="btn" id="next" onclick="location.href='shift-progress-step2-head.php'">Next</button>
...
function TeamAdd(nameteamValue) {
    $.ajax({
        type: "POST",
        url: "../processing/process_shift_insert_addteam_head.php",
        data: {
...
function AddTeamEmployee() {
    ...
    $.ajax({
        type: "POST",
        url: "../processing/process_shift_insert_addTeamEmployee_head.php",
        data: {
            team: Team,
...
//desktop script
function add_member() {
    var employee = document.getElementById("desktop-headid").value;
...
function add_team_member() {
    ...
    var des_employeeid = [];
    $('#desktop-headid option:selected').each(function() {
