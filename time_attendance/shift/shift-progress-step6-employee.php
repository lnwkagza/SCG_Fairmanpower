...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/shift-add-employee.css">
...
if (isset($_SESSION["card_id"])) {
    ...
    $select_shift_data_query = "SELECT firstname_thai, lastname_thai, date, input_timestamp,
    ...
    if ($result) {
        ...
        if (!empty($row['sub_team_id'])) {
            $select_shift_team = "SELECT scg_employee_id, firstname_thai, lastname_thai,card_id,date, day, shift_main, shift_add, shift_lock
                                FROM employee
...
<script type="text/javascript">
    function mobile_add_addShift() {
        var popupContent =
            '<form id="myForm" action="../processing/process_shift_insert_shift_add_shift_employee.php" method="POST">' +
            '<div class="topic">เพิ่มรายการใหม่</div><br>' +
            '<div class="content1">ชื่อ - สกุล</div>' +
            '<select class="form-control" name="team_member" id="team_member" onchange="employee_oldshift()" > ' +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../processing/process_shift_insert_shift_add_shift_employee.php",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    function display_employee_oldshift() {
        var employeeid = document.getElementById("team_member").value;
    ...
    function submit_form() {
        ...
        form.action = '../processing/process_shift_insert_shift_add_shift_employee.php';
        form.method = 'POST';
        form.submit();
    }
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-6">
                            ...
                            <div class="circle active"><a href="shift-progress-step6-employee.php">
                                    <span>6</span><span class="title">เพิ่มกะ</span></a></div>
                        </div>
                    </div>
                    <div class="btn-action-step">
                        <button class="button-step" id="prev" onclick="location.href='shift-progress-step5-employee.php'">ก่อนหน้า</button>
                    </div>
                    <div class="row">
                                    ...
                                    <form id="desktop-form">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control" name="team_member" id="team_member" onchange="display_employee_oldshift()">
                                                        <option value="">เลือกสมาชิกในทีม</option>
                                                        <?php echo $options; ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control" name="inspector" id="desktop-inspector">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>หัวหน้า</label>
                                                    <input type="hidden" name="approver_id" value="<?php echo $approver_card_id; ?>">
        ...
        <div class="container">
            ...
            <div class="container-progress">
                <div class="progress-container step-6">
                    ...
                    <div class="circle active"><a href="shift-progress-step5-employee.php">
                            <span>5</span><span class="title">เปลี่ยนกะ</span></a></div>
                    <div class="circle active"><a href="shift-progress-step1-employee.php">
                            <span>6</span><span class="title">เพิ่มกะ</span></a></div>
                </div>
            </div>
