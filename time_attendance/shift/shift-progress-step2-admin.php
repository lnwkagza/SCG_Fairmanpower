...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/admin/shift-table-now-admin.css">
...
function submit_form() {
    ...
    form.action = '../processing/process_shift_edit_workformat_Request.php';
    form.method = 'POST';
    form.submit();
}
</script>
                ...
                <div class="min-height-200px">
                    ...
                    <div class="progress-step">
                        <div class="progress-container step-2">
                            <div class="circle active"><a href="shift-progress-step1-admin.php"><span>1</span><span
                            ...
                            <div class="circle"><a href="shift-progress-step3-admin.php">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev"
                            onclick="location.href='shift-progress-step1-admin.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next"
                            onclick="location.href='shift-progress-step3-admin.php'">ถัดไป</button>
                    </div>
        ...
        <div class="container">
            ...
            <div class="container-editWork">
                ...
                <div class="display-editWork-step2">
                    <form id="myForm" action="../processing/process_shift_edit_workformat_Request.php" method="POST">
            ...
            <div class="btn-action-step">
                <button class="btn" id="prev" onclick="location.href='shift-progress-step1-admin.php'">Prev</button>
                <button class="btn" id="next" onclick="location.href='shift-progress-step3-admin.php'">Next</button>
            </div>
        </div>
    </div>
