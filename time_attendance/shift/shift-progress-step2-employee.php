...
<!-- CSS Desktop -->
<link rel="stylesheet" href="../components-desktop/employee/shift-table-now-employee.css">
...
<body>
                ...
                <div class="min-height-200px">
                    ...
                    <div class="btn-action-step">
                        <button class="button-step" id="prev"
                            onclick="location.href='shift-progress-step1-employee.php'">ก่อนหน้า</button>
                        <button class="button-step" id="next"
                            onclick="location.href='shift-progress-step3-employee.php'">ถัดไป</button>
                    </div>
    ...
    <div class="mobile">
        ...
        <div class="container">
            ...
            <div class="btn-action-step">
                <button class="btn" id="prev" onclick="location.href='shift-progress-step1-employee.php'">Prev</button>
                <button class="btn" id="next" onclick="location.href='shift-progress-step3-employee.php'">Next</button>
            </div>
        </div>
    </div>
