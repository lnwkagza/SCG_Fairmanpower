        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="listemployee_Create.php" class="dropdown-toggle no-arrow"><i class="fa-solid fa-user-plus"></i> เพิ่มพนักงานใหม่</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="../Payment-SCG-main/admin/check_admin_split.php"  class="dropdown-toggle no-arrow">
