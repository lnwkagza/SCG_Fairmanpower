...
<?php
	...
	WHERE Tablechapter.general_target = 1 ORDER BY course_date DESC";
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="title">
                                <span id="head">หลักสูตรอื่นๆ</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="contianer">
                                        ...
                                        <div class="manucon">
                                            <div class="manuselect">
                                                <div class="manuoff"><a href=""><button>หลักสูตรอื่นๆ</button></a></div>
                                            </div>
