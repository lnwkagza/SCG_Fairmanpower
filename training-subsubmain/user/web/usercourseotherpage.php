...
<link rel="stylesheet" href="../css/usercoursepage.css">
...
<?php
    ...
    WHERE Tablepositiontarget.person_id = ? AND Tablechapter.chapter_type = N'อื่นๆ' AND (Tabletrainningdata.person_id = ? OR Tabletrainningdata.person_id IS NULL)
...
<?php include('../../components/navbaruserall.php') ?>
                                    ...
                                    <div class="contianer">
                                        ...
                                        <div class="manucon">
                                            <div class="manuselect">
                                                <div class="manuoff"><a href="usercoursetargetpage.php"><button>ตามตำเเหน่ง</button></a></div>
                                                <div class="manuoff"><a href="usercourselawpage.php"><button>กฎหมายบังคับ</button></a></div>
                                                <div class="manuoff"><a href="usercoursebasicpage.php"><button>พื้นฐาน</button></a></div>
                                                <div class="manuon"><a href="#"><button>อื่นๆ</button></a></div>
                                            </div>
    ...
    <script>
        ...
        function redirectToNextPage(chapterId, courseName) {
            ...
            Swal.fire({
                title: 'คลิปจบแล้ว',
                text: 'ต้องการทำแบบทดสอบต่อหรือไม่?',
                icon: 'question',
