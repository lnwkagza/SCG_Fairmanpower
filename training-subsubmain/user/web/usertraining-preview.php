                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                        <div class="card-box pd-10 pt-10 height-100-p">
                            <div class="bar">
                                <div class="mainclass">
                                    <div class="head">
                                        <div id="add">รายละเอียดข้อมูลการฝึกอบรม</div>
                                        <div class="btn-export">
                                            <button id="excel">Excel <i class="bi bi-file-earmark-excel"></i></button>
                                            <button id="pdf">PDF <i class="bi bi-file-earmark-pdf"></i></button>
                                        </div>
                                    </div>
                                    <div class="data">
                                        <div class="row1">
                                            ...
                                            <div class="hour">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="กรุณากรอกจำนวนชั่วโมงที่ฝึกอบรม" disabled>
                                            </div>
                                        </div>
                                        <div class="row2">
                                            <div class="location">
                                        ...
                                        <div class="row4">
                                            ...
                                            <div class="row4-1">
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 1" disabled>
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 2" disabled>
                                            </div>
                                            <div class="row4-2">
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 3" disabled>
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 4" disabled>
                                            </div>
                                            <div class="row4-3">
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 5" disabled>
                                                <input type="text" autocomplete="off" placeholder="ท่านที่ 6" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row6">
                                            ...
                                            <div class="data-b">
                                                <div class="c-row1">
                                                    ...
                                                    <input class="channel1" type="number" placeholder="กรุณาระบุจำนวนเงิน" autocomplete="off" disabled>
                                                    <span class="to">X</span>
                                                    <input type="number" id="people" autocomplete="off" disabled>
                                                    <span>คน</span>
                                                    <input class="channel2" type="number" placeholder="กรุณาระบุจำนวนเงินรวม" autocomplete="off" disabled>
                                                    <span>บาท</span>
                                                </div>
                                                <div class="c-row2">
                                                    <input type="checkbox" disabled>
                                                ...
                                                <div class="result">
                                                    ...
                                                    <input class="channel2-2" type="number" placeholder="สรุปค่าอบรมทั้งหมด" autocomplete="off" disabled>
                                                    <span>บาท</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row7">
                                            ...
                                            <div class="result">
                                                ...
                                                <input class="channel1" type="number" placeholder="จำนวนเงินรวม"  autocomplete="off" disabled>
                                                <span class="to">/</span>
                                                <input type="number" id="people" autocomplete="off" disabled>
                                                <span>คน</span>
                                                <input class="channel2" type="number" placeholder="ราคารวมต่อท่าน" autocomplete="off" disabled>
                                                <span>บาท</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="course-closed">
                                        <span>ปิดหลักสูตร</span>
                                    </div>

                                    <div class="button">
                                        <div class="button-l">
                                            <div class="justify-content-left">
                                                <button style="font-size:20px;" onclick="location.href='usertraining-record.php'" type="button" class="btn btn-default" data-dismiss="modal"><i class="bi bi-arrow-left-circle-fill"></i> ย้อนกลับ</button>
                                            </div>
                                        </div>
                                        <div class="button-r">
                                            <a class="approv" href="">ขออนุมัติอบรม</a>
                                            <a class="edit" href="usertraining-edit.php">แก้ไข</a>
                                            <button>ลบ</button>
