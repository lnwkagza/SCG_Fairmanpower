...
<?php
    ...
    WHERE Tablepositiontarget.person_id = ? AND Tablechapter.chapter_type = N'พื้นฐาน' AND (Tabletrainningdata.person_id = ? OR Tabletrainningdata.person_id IS NULL)
                                    ...
                                    <div class="contianer">
                                        ...
                                        <div class="manucon">
                                            <div class="manuselect">
                                                ...
                                                <div class="manuon"><a href="#"><button>พื้นฐาน</button></a></div>
