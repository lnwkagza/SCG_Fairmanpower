...
<link rel="stylesheet" href="../css/userselflearningpage.css">
                    ...
                    <div class="card-box pd-10 pt-10 height-100-p">
                        <div class="bar">
                            <div class="mainclass">
                                ...
                                <div class="menubar">
                                    <div class="menu2"><a href="userOJTpage.php" class="a3">OJT</a></div>
                                ...
                                <div class="inputcon">
                                    ...
                                    <form action="../../backend/db_userselflearningpage.php" method="post" enctype="multipart/form-data">
