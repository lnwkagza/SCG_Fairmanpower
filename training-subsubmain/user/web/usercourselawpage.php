...
<?php
    ...
    WHERE Tablepositiontarget.person_id = ? AND Tablechapter.chapter_type = N'กฎหมายบังคับ' AND (Tabletrainningdata.person_id = ? OR Tabletrainningdata.person_id IS NULL)
                                    ...
                                    <div class="contianer">
                                        ...
                                        <div class="manucon">
                                            <div class="manuselect">
                                                ...
                                                <div class="manuon"><a href="#"><button>กฎหมายบังคับ</button></a></div>
                                                <div class="manuoff"><a href="usercoursebasicpage.php"><button>พื้นฐาน</button></a></div>
                                                <div class="manuoff"><a href="usercourseotherpage.php"><button>อื่นๆ</button></a></div>
                                            </div>
