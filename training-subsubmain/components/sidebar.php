        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="admincoursetargetpage.php" class="dropdown-toggle no-arrow">หลักสูตรที่ต้องเรียนรู้</a></li>
                        <li><a href="adminsubcourseotherpage.php" class="dropdown-toggle no-arrow">หลักสูตรอื่นๆ</a></li>
                        <li><a href="adminOJTpage.php" class="dropdown-toggle no-arrow">OJT/Self Learning</a></li>
                        <li><a href="adminlearnsummary.php" class="dropdown-toggle no-arrow">สรุปผลการเรียนรู้</a></li>
                        <li><a href="" class="dropdown-toggle no-arrow">Dashboard</a></li>
                        <li><a href="training.php" class="dropdown-toggle no-arrow">ฝึกอบรม</a></li>
                        <li><a href="uploadadminmain.php" class="dropdown-toggle no-arrow">อัพโหลดหลักสูตร</a></li>
                    </ul>
                </li>
                <li>
