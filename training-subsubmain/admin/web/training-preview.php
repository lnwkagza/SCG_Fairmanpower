                                    ...
                                    <div class="button">
                                        <div class="button-l">
                                            <div class="justify-content-left">
                                                <button style="font-size:20px;" onclick="location.href='training.php'" type="button" class="btn btn-default" data-dismiss="modal"><i class="bi bi-arrow-left-circle-fill"></i> ย้อนกลับ</button>
                                            </div>
                                        </div>
                                        <div class="button-r">
                                            <a class="approv" href="">ขออนุมัติอบรม</a>
                                            <a class="edit" href="training-edit.php">แก้ไข</a>
                                            <button>ลบ</button>
