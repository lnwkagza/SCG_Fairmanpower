                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="title">
                                <span id="head">เพิ่มกลุ่มเป้าหมาย</span>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                        <div class="card-box pd-10 pt-10 height-100-p">
                            <div class="bar">
                                <div class="mainclass" style="background-color: none;">
                                    <div class="addcourse">
                                        <!-- <div class="selectall"><button onclick="selectAllCheckboxes()">CheckAll</button></div> -->
                                        <div class="searchmanu">
                                            <form action="addchapter_to_addtarget.php" method="POST">
                                    ...
                                    <div class="tablecourse">
                                        <form action="../../backend/db_addchapter_to_addtarget.php" method="POST">
                                            <table>
                                                <tr>
                                            ...
                                            <div class="buttonsubmmit"><button type="submit" name="save">ถัดไป</button></div>
                                        </form>
