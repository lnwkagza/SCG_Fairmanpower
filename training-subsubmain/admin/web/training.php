                            ...
                            <div class="bar">
                                <div class="mainclass">
                                    <div class="addData">
                                        ...
                                        <a href="training-add.php"><i class="bi bi-plus-circle-fill"></i> เพิ่มข้อมูล</a>
                                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btintb">
                                                            <a class="detail" href="training-preview.php"><i class="bi bi-info"></i></a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    <div class="btintb">
                                                            <a class="edit" href="training-edit.php"><i class="bi bi-pencil-square"></i></a>
