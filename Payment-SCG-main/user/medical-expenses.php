<!-- รายละเอียด เบิกค่ารักษาพยาบาล -->
<?php include('../user/include/header.php') ?>
<link rel="stylesheet" href="styles/medical-expenses.css">
...
<body>
    <div class="main-container">
        ...
        <div class="content">
            <div class="btn">
                <a href="medical-expenses-add.php"><span><i class="fa-solid fa-plus"></i> ขอเอกสารคำร้อง</span></a>
            </div>
            <div class="tb">
                <table>
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="data-l">
                                    <span class="bold">ยื่นขอ "ค่ารักษาพยาบาล"</span>
                                    <span>ยื่นขอวันที่ 18/01/2024</span>
                                    <span>รายละเอียด : เบิกค่ารักษา</span>
                                </div>
                            </td>
                            <td class="status">
                                <div class="data-r">
