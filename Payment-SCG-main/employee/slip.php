                                        ...
                                        <table class="data-table2 table stripe hover nowrap" id="myTable" style="border-collapse: collapse; width: 100%; background-color: white;">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                    ...
                                                    if ($row["deduct_amount"] !== NULL) {
                                                        ...
                                                        echo "<td style='text-align: left; border-left: 1px solid #d0cdcd; border-right: 1px solid #d0cdcd;'></td>";
                                                        echo "<td style='text-align: left; border-left: 1px solid #d0cdcd; border-right: 1px solid #d0cdcd;'></td>";
                                                    }
                                                    echo '</tr>';
                                                }
                                            ...
                                            ";
                                                ...
                                                if ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                    ...
                                                    echo "<td style='text-align: right; right; padding-right: 10px; border: 1px solid #d0cdcd; border-bottom: none;'>" . number_format($row["salary_per_month"] + $row["income_amount"], 2) . "</td>";
                                                    echo "<td style='text-align: left; padding-left: 10px; border: 1px solid #d0cdcd; border-bottom: none;'>" . 'รวมรายจ่ายทั้งหมด' . "</td>";
                                                    echo "<td style='text-align: right; right; padding-right: 10px; border: 1px solid #d0cdcd; border-bottom: none;'>" . number_format($row["salary_per_month"] * 0.05 + $row["deduct_amount"], 2) . "</td>";
                                                    echo '</tr></td>';
                                                }
                                                ?>
                                                <?php
