        ...
        <div class="pd-ltr-20 xs-pd-20">
            <div class="min-height-200px">
                ...
                <div class="row">
                            ...
                            <div class="pb-10">
                                <div class="table-responsive mt-2">
                                    <table class="data-table2 table stripe hover nowrap">
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = circle.card_id
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertcircleModal" tabindex="-1" role="dialog" aria-labelledby="insertcircleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="text-light-green">
                                        <h4><label>+ เพิ่มการตั้งค่ารอบวันที่ </label></h4>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <h6>รอบวันที่</h6>
                                    <form method="post" action="setting_payment_circle.php">
                                        <section>
                                            <div class="col-md-7 col-sm-7">
                                                <div class="form-group pt-1">
                                                    <select id="circle_setDropdown" name="circle_set_id" class="custom-select" required="true" autocomplete="off">
                                                        <option value="" disabled selected>เลือกรอบวันที่</option>
                                                        <?php
                                                        ...
                                                        if ($resultDropdown_type) {
                                                            while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                                echo "<option value='" . $row['circle_set_id'] . "'>" . $row['circle'] . "</option>";
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        if (isset($_POST['submit'])) {
                                            $circle_set_id = $_POST['circle_set_id'];
                                            ...
                                            if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    $sqlMerge = "MERGE INTO circle AS target
                                            USING (
                                            ...
                                            ) AS source (circle_set_id, card_id)
                                            ON target.card_id = source.card_id
                                            WHEN MATCHED THEN
                                                UPDATE SET target.circle_set_id = source.circle_set_id
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";

                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessioncompany, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondivision, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessiondepartment, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $sessionsection, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($circle_set_id, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $sessioncompany);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $sessiondivision);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $sessiondepartment);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $sessionsection);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $cost_center_id);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (circle_set_id, card_id) VALUES (source.circle_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($circle_set_id, $card_id);
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลรอบวันที่สำเร็จ"
                                            });            
                                            </script>';
                    ...
                    <div class="modal fade" id="editcircleModal" tabindex="-1" role="dialog" aria-labelledby="editcircleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">แก้ไขรอบวันที่</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="setting_payment_circle.php">
                                        ...
                                        <?php
                                            ...
                                            if ($resultDropdown_type) {
                                                while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                    $circleValue =  $row["circle"] ;
                                                    echo "<option value='" . $row['circle_set_id'] . "'>" . $circleValue . "</option>";
                                                }
                                            }
                                            ?>
                                        </select>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="update_circle">บันทึกการแก้ไข</button>
                                        </div>
                                    </form>
                                    ...
                                    if (isset($_POST['update_circle'])) {
                                        $circle_id  = $_POST['circle_id'];
                                        $circle_set_id = $_POST['circle_set_id'];

                                        // อัปเดตค่าของฟิลด์ income_type
                                        $sqlUpdate = "UPDATE circle SET circle_set_id = '$circle_set_id' WHERE circle_id = '$circle_id'";
