        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="title">
                                <h3>ตั้งค่างวดการจ่าย</h3>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="setting_payment_circle.php">ตั้งค่ารอบวันที่</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">ตั้งค่างวดการจ่าย</li>
                ...
                <div class="row">
                                ...
                                <div class="title ">
                                    <div class="row">
                                        ...
                                        <div class="text-right col-3">
                                            <button onclick="openSplit_Setting_Modal()" type="button" class="btn insert-btn-pay" data-dismiss="modal">
                                                + เพิ่มการตั้งค่างวดการจ่าย
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="pb-10">
                                <table class="data-table2 table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = split.card_id
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertsplitModal" tabindex="-1" role="dialog" aria-labelledby="insertsplitModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="text-light-green">
                                        <h4><label>+ เพิ่มการตั้งค่างวดการจ่าย </label></h4>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <h6>งวดการจ่าย</h6>
                                    <form method="post" action="setting_payment_split.php">
                                        <section>
                                            <div class="col-md-7 col-sm-7">
                                                <div class="form-group pt-1">
                                                    <select id="split_setDropdown" name="split_set_id" class="custom-select" required="true" autocomplete="off">
                                                        <option value="" disabled selected>เลือกงวดการจ่าย</option>
                                                        <?php
                                                        $sqlDropdown_type = "SELECT * FROM split_set";
                                                        ...
                                                        if ($resultDropdown_type) {
                                                            while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                                echo "<option value='" . $row['split_set_id'] . "'>" . $row['split'] . '  งวด' . "</option>";
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        if (isset($_POST['submit'])) {
                                            $split_set_id = $_POST['split_set_id'];
                                            ...
                                            if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    $sqlMerge = "MERGE INTO split AS target
                                            USING (
                                            ...
                                            ) AS source (split_set_id, card_id)
                                            ON target.card_id = source.card_id
                                            WHEN MATCHED THEN
                                                UPDATE SET target.split_set_id = source.split_set_id
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";

                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessioncompany, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondivision, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessiondepartment, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $sessionsection, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($split_set_id, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $sessioncompany);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $sessiondivision);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $sessiondepartment);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $sessionsection);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $cost_center_id);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (split_set_id, card_id) VALUES (source.split_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($split_set_id, $card_id);
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลงวดการจ่ายสำเร็จ"
                                            });            
                                            </script>';
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="editsplitModal" tabindex="-1" role="dialog" aria-labelledby="editsplitModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">แก้ไขงวดการจ่าย</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="setting_payment_split.php">
                                        ...
                                        <h6><label for="split_set_id">งวดการจ่าย</label></h6>
                                        <select id="split_set_id" name="split_set_id" class="custom-select" required="true" autocomplete="off">
                                            <option value="" selected>เลือกงวดการจ่าย</option>
                                            <?php
                                            $sqlDropdown_type = "SELECT * FROM split_set";
                                            ...
                                            if ($resultDropdown_type) {
                                                while ($row_dropdown = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                    ...
                                                    echo "<option value='" . $row_dropdown['split_set_id'] . "' " . $selected . ">" . $row_dropdown['split'] . '  งวด' . "</option>";
                                                }
                                            }
                                            ?>
                                        </select>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="update_split">บันทึกการแก้ไข</button>
                                        </div>
                                    </form>
                                    ...
                                    if (isset($_POST['update_split'])) {
                                        $split_id  = $_POST['split_id'];
                                        $split_set_id = $_POST['split_set_id'];

                                        // อัปเดตค่าของฟิลด์ income_type
                                        $sqlUpdate = "UPDATE split SET split_set_id = '$split_set_id' WHERE split_id = '$split_id'";
