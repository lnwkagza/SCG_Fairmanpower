        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">ตั้งค่าประกันสังคม</li>
                ...
                <div class="row">
                        ...
                        <div class="card-box pd-20 pt-10 height-100-p">
                                ...
                                <div class="title ">
                                    <div class="row">
                                        ...
                                        <div class="text-right col-4">
                                            <button onclick="openSocial_securityy_Setting_Modal()" type="button" class="btn insert-btn-pay" data-dismiss="modal">
                                                + เพิ่มการตั้งค่าอัตราประกันสังคม
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive mt-2">
                                    <table class="data-table2 table stripe hover nowrap">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;">อัตราประกันสังคม</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        // เตรียมคำสั่ง SQL
                                        $sql = "SELECT social_security.social_security_id as social_security_id,scg_employee_id,social_security, employee.card_id as card_id, company.name_thai as company,division.name_thai as division,department.name_thai as department,section.name_thai as section,cost_center.cost_center_code as cost_center,contract_type.name_thai as contract_type,pl.pl_name_thai as pl,position.name_thai as position , prefix_thai, firstname_thai, lastname_thai FROM social_security  
                                        INNER JOIN employee ON employee.card_id = social_security.card_id  
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = social_security.card_id
                                        LEFT JOIN pl ON pl.pl_id = pl_info.pl_id 
                                        LEFT JOIN position_info ON position_info.card_id  = social_security.card_id
                                        ...
                                        while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                            echo "<tr>";
                                            echo "<td  style='text-align: center;''>" . $row["social_security"] . '  %' . "</td>";
                                            ...
                                            '<button type="button" name="delete_social_security" class="delete-btn-pay" onclick="confirmDeleteSocial_security(\'' . $row['social_security_id'] . '\');"><i class="fa-solid fa-trash-can"></i></button> &nbsp;';
                                            echo "<button type='button' class='edit-btn-pay' onclick='openEdit_Social_security_Setting_Modal
                                            (
                                            \"" . $row['social_security_id'] . "\",
                                            \"" . $row['card_id'] . "\",
                                            \"" . $row['social_security'] . "\",
                                            \"" . $row['prefix_thai'] . "\",
                                            \"" . $row['firstname_thai'] . "\",
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertsocial_securityModal" tabindex="-1" role="dialog" aria-labelledby="insertsocial_securityModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="text-light-green">
                                        <h4><label>+ เพิ่มการตั้งค่าประกันสังคม </label></h4>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <h6>อัตราประกันสังคม (%)</h6>
                                    <form method="post" action="setting_payment_social_security.php">
                                        <section>
                                            <div class="col-md-7 col-sm-7">
                                                <div class="form-group pt-1">
                                                    <div class="form-group">
                                                        <input id="social_security" name="social_security" type="number" value="5" class="form-control" required="true" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <h6>กลุ่มเป้าหมาย</h6>
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        if (isset($_POST['submit'])) {
                                            ...
                                            if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    $sqlMerge = "MERGE INTO social_security AS target
                                            USING (
                                            ...
                                            ) AS source (social_security, card_id)
                                            ON target.card_id = source.card_id
                                            WHEN MATCHED THEN
                                                UPDATE SET target.social_security = source.social_security
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";

                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessioncompany, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondivision, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessiondepartment, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $sessionsection, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($social_security, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $sessioncompany);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $sessiondivision);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $sessiondepartment);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $sessionsection);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $cost_center_id);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (social_security, card_id) VALUES (source.social_security, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($social_security, $card_id);
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลประกันสังคมสำเร็จ"
                                            });            
                                            </script>';
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="editsocial_securityModal" tabindex="-1" role="dialog" aria-labelledby="editsocial_securityModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">แก้ไขอัตราประกันสังคม</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="setting_payment_social_security.php">
                                        <input type="hidden" id="social_security_id" name="social_security_id">
                                        ...
                                        <h6><label for="editsocial_security">อัตราประกันสังคม (%)</label></h6>
                                        <div class="form-group">
                                            <input id="editsocial_security" name="social_security" type="number" class="form-control" required="true" autocomplete="off">
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="update_social_security">บันทึกการแก้ไข</button>
                                        </div>
                                    </form>
                                    ...
                                    if (isset($_POST['update_social_security'])) {
                                        $social_security_id  = $_POST['social_security_id'];
                                        $social_security = $_POST['social_security'];

                                        // อัปเดตค่าของฟิลด์ income_type
                                        $sqlUpdate = "UPDATE social_security SET social_security = '$social_security' WHERE social_security_id = '$social_security_id'";
