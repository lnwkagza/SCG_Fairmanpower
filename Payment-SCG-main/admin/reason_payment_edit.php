...
if (isset($_GET['id']) && isset($_GET['card_id'])) {
    // นำค่า firstname_thai ที่ถูกส่งมาจาก URL parameters ไปใช้งาน
    $employee_payment_id = $_GET['id'];
    $_SESSION['id'] = $employee_payment_id; // เก็บค่าใน session
    $e_card_id = $_GET['card_id'];
    $_SESSION['e_card_id'] = $e_card_id; // เก็บค่าใน session
...
<body>
    <div class="container d-flex justify-content-center align-items-center main">
        <div class="signup-box">
            ...
            <form action="insert_reason_payment_edit.php" method="POST">
                <input type="text" placeholder="กรุณากรอกเหตุผล" name="reason_payment" autocomplete="off" required>
