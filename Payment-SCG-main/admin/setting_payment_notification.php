        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">ตั้งค่าการแจ้งเตือน</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="card-box pd-20 pt-10 height-100-p">
                                ...
                                <div class="title ">
                                    <div class="row">
                                        ...
                                        <div class="text-right col-4">
                                            <button onclick="openNotification_Setting_Modal()" type="button" class="btn insert-btn-pay" data-dismiss="modal">
                            ...
                            <div class="pb-10">
                                <table class="data-table2 table stripe hover nowrap">
                                    <thead>
                                        <tr>
                                            <th class="datatable-nosort " style="text-align: center;">หนังสือรับรองเงินเดือน <i class="fa-solid fa-sort"></i></th>
                                            <th class="datatable-nosort " style="text-align: center;">ค่ารักษาพยาบาล <i class="fa-solid fa-sort"></i></th>
                                            <th class="datatable-nosort col-7">
                                                Company / Division / Department / Section / Cost Center / ประเภทพนักงาน / ระดับการทำงาน / ตำแหน่ง
                                                <i class="fa-solid fa-sort"></i>
                                            </th>
                                            <th class="datatable-nosort " style='text-align: right; padding-right: 40px;'>การจัดการ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!-- SELECT ค่า cicle -->
                                        <?php
                                        // เตรียมคำสั่ง SQL
                                        $sql = "SELECT notification_id,notification_certificate.notification_certificate as notification_certificate,notification_medical.notification_medical as notification_medical, employee.card_id as card_id, company.name_thai as company,division.name_thai as division,department.name_thai as department,section.name_thai as section,cost_center.cost_center_code as cost_center,contract_type.name_thai as contract_type,pl.pl_name_thai as pl,position.name_thai as position , prefix_thai, firstname_thai, lastname_thai FROM notification  
                                        INNER JOIN notification_certificate ON notification_certificate.notification_certificate_id  = notification.notification_certificate_id 
                                        INNER JOIN notification_medical ON notification_medical.notification_medical_id  = notification.notification_medical_id 
                                        INNER JOIN employee ON employee.card_id = notification.card_id  
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = notification.card_id
                                        LEFT JOIN pl ON pl.pl_id = pl_info.pl_id 
                                        LEFT JOIN position_info ON position_info.card_id  = notification.card_id
                                        ...
                                        while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                            echo "<tr>";
                                            $displayCertificate = ($row["notification_certificate"] === 0) ? "เปิดการแจ้งเตือน" : (($row["notification_certificate"] === 1) ? "ปิดการแจ้งเตือน" : $row["notification_certificate"]);
                                            echo "<td  style='text-align: center;''>" . $displayCertificate . "</td>";
                                            $displayMedical = ($row["notification_medical"] === 0) ? "เปิดการแจ้งเตือน" : (($row["notification_medical"] === 1) ? "ปิดการแจ้งเตือน" : $row["notification_medical"]);
                                            echo "<td  style='text-align: center;''>" . $displayMedical . "</td>";
                                            echo "<td>" . $row["company"] . ' / ' . $row["division"] . ' / ' . $row["department"] . ' / ' . $row["section"] . ' / ' . $row["cost_center"] . '<br>' . $row["contract_type"] . ' / ' . $row["pl"] . ' / ' . $row["position"] . ' / ' . $row["prefix_thai"] . $row["firstname_thai"] . '  ' . $row["lastname_thai"] . "</td>";
                                            echo "<td><div class='flex'  style='justify-content: right; padding-right: 27px;'>",
                                            '<button type="button" name="delete_notification" class="delete-btn-pay" onclick="confirmDeleteNotification(\'' . $row['notification_id'] . '\');"><i class="fa-solid fa-trash-can"></i></button> &nbsp;';
                                            echo "<button type='button' class='edit-btn-pay' onclick='openEdit_Notification_Setting_Modal
                                            (
                                            \"" . $row['notification_id'] . "\",
                                            \"" . $row['card_id'] . "\",
                                            \"" . $row['notification_certificate'] . "\",
                                            \"" . $row['notification_medical'] . "\",
                                            \"" . $row['prefix_thai'] . "\",
                                            \"" . $row['firstname_thai'] . "\",
                                            \"" . $row['lastname_thai'] . "\",
                                            \"" . $row['company'] . "\",
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertnotificationModal" tabindex="-1" role="dialog" aria-labelledby="insertnotificationModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="text-light-green">
                                        <h4><label>+ เพิ่มการตั้งค่าการแจ้งเตือน </label></h4>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <h6>หนังสือรับรองเงินเดือน</h6>
                                    <form method="post" action="setting_payment_notification.php">
                                        <section>
                                            <div class="col-md-7 col-sm-7">
                                                <div class="form-group pt-1">
                                                    <select id="notification_certificateDropdown" name="notification_certificate_id" class="custom-select" required="true" autocomplete="off">
                                                        <option value="" disabled selected>เลือการแจ้งเตือน</option>
                                                        <?php
                                                        $sqlDropdown_type = "SELECT * FROM notification_certificate";
                                                        ...
                                                        if ($resultDropdown_type) {
                                                            while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                                $notification_certificateValue = ($row['notification_certificate'] == 0) ? 'เปิดการแจ้งเตือน' : 'ปิดการแจ้งเตือน';
                                                                echo "<option value='" . $row['notification_certificate_id'] . "'>" . $notification_certificateValue . "</option>";
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <h6>ค่ารักษาพยาบาล</h6>
                                            <form method="post" action="setting_payment_notification.php">
                                                <section>
                                                    <div class="col-md-7 col-sm-7">
                                                        <div class="form-group pt-1">
                                                            <select id="notification_medicalDropdown" name="notification_medical_id" class="custom-select" required="true" autocomplete="off">
                                                                <option value="" disabled selected>เลือการแจ้งเตือน</option>
                                                                <?php
                                                                $sqlDropdown_type = "SELECT * FROM notification_medical";
                                                                $resultDropdown_type = sqlsrv_query($conn, $sqlDropdown_type);
                                                                ...
                                                                if ($resultDropdown_type) {
                                                                    while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                                        $notification_medicalValue = ($row['notification_medical'] == 0) ? 'เปิดการแจ้งเตือน' : 'ปิดการแจ้งเตือน';
                                                                        echo "<option value='" . $row['notification_medical_id'] . "'>" . $notification_medicalValue . "</option>";
                                                                    }
                                                                }
                                                                ?>
                                                            </select>
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                if (isset($_POST['submit'])) {
                                                    $notification_certificate_id = $_POST['notification_certificate_id'];
                                                    $notification_medical_id = $_POST['notification_medical_id'];
                                                    ...
                                                    if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                        if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                            ...
                                                            $sqlMerge = "MERGE INTO notification AS target
                                            USING (
                                                ...
                                                ) AS source (notification_certificate_id,notification_medical_id, card_id)
                                                ON target.card_id = source.card_id
                                                WHEN MATCHED THEN
                                                    UPDATE SET target.notification_certificate_id = source.notification_certificate_id,
                                                               target.notification_medical_id = source.notification_medical_id
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";

                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $contract_type_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision,  $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment,  $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision,  $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment,  $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";;
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $contract_type_id, $pl_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $contract_type_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $sessionsection, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            USING (
                                                ...
                                                WHEN NOT MATCHED THEN
                                                    INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                            ...
                                                            // กำหนดค่าพารามิเตอร์
                                                            $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                        ...
                                        USING (
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id);
                                        ...
                                        USING (
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $sessioncompany);
                                        ...
                                        USING (
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $sessiondivision);
                                         ...
                                         USING (
                                             ...
                                             WHEN NOT MATCHED THEN
                                                 INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $sessiondepartment);
                                        ...
                                        USING (
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $sessionsection);
                                        ...
                                        USING (
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $cost_center_id);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (notification_certificate_id,notification_medical_id, card_id) VALUES (source.notification_certificate_id,source.notification_medical_id, source.card_id);";
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($notification_certificate_id, $notification_medical_id, $card_id);
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลการแจ้งเตือนสำเร็จ"
                                            });            
                                            </script>';
                    ...
                    <div class="modal fade" id="editnotificationModal" tabindex="-1" role="dialog" aria-labelledby="editnotificationModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">แก้ไขการแจ้งเตือน</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="setting_payment_notification.php">
                                        ...
                                        <h6><label for="notification_certificate_id">หนังสือรับรองเงินเดือน</label></h6>
                                        <select id="notification_certificate_id" name="notification_certificate_id" class="custom-select" required="true" autocomplete="off">
                                        <option value="" selected disabled>เลือกการแจ้งเตือน</option>
                                            <?php
                                            $sqlDropdown_type = "SELECT * FROM notification_certificate";
                                            $resultDropdown_type = sqlsrv_query($conn, $sqlDropdown_type);
                                        ...
                                        <div class="mt-3">
                                            <h6><label for="notification_medical_id">ค่ารักษาพยาบาล</label></h6>
                                        </div>
                                        <select id="notification_medical_id" name="notification_medical_id" class="custom-select" required="true" autocomplete="off">
                                        <option value="" selected disabled>เลือกการแจ้งเตือน</option>
                                            <?php
                                            $sqlDropdown_type = "SELECT * FROM notification_medical";
                                            $resultDropdown_type = sqlsrv_query($conn, $sqlDropdown_type);
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="update_notification">บันทึกการแก้ไข</button>
                                        </div>
                                    </form>
                                    <?php
                                    ...
                                    if (isset($_POST['update_notification'])) {
                                        ...
                                        $sqlUpdate = "UPDATE notification SET notification_certificate_id = '$notification_certificate_id', notification_medical_id = '$notification_medical_id' WHERE notification_id = '$notification_id'";
