                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">ตั้งค่าแบบฟอร์ม</li>
                                ...
                                <div class="title ">
                                    <div class="row">
                                        ...
                                        <div class="text-right col-4">
                                            <button onclick="openForm_Setting_Modal()" type="button" class="btn insert-btn-pay" data-dismiss="modal">
                                                + เพิ่มการตั้งค่าแบบฟอร์ม
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive mt-2">
                                <table class="data-table2 table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = form.card_id
                                        LEFT JOIN pl ON pl.pl_id = pl_info.pl_id 
                                        LEFT JOIN position_info ON position_info.card_id  = form.card_id
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    if (isset($_POST['submit'])) {
                                        ...
                                        if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                            ...
                                            WHEN MATCHED THEN
                                                UPDATE SET target.form_set_id = source.form_set_id
                                        ...
                                        if ($resultInsert === false) {
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลแบบฟอร์มสำเร็จ"
                                            });            
                                            </script>';
