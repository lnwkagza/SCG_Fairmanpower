                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="title">
                                <h3>การตั้งค่า : Setting Payment</h3>
                            </div>
                ...
                <div class="card-box pd-20 pt-20 height-50-p">
                    <div class="col-md-10 col-sm-12">
                        <div class="form-group">
                            <div class="text-left">
                                <button class="btn setting-btn-pay" onclick="location.href='setting_payment_income_deduct.php'">ตั้งค่ารายรับ/รายจ่ายอื่นๆ</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10 col-sm-12">
                        <div class="form-group">
                            <div class="text-left">
                                <button class="btn setting-btn-pay" onclick="location.href='setting_payment_general.php'">ตั้งค่าทั่วไป</a></button>
                            </div>
                        </div>
                    </div>
