<!-- เอกสารรอการอนุมัติ หน้าทั้งหมด -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-sm-12 mb-30">
                        <div class="card-box pd-30 pt-10 height-100-p">
                            <div class="bar">
                                <a href="calculator_payment2.php">คำนวณเงินเดือนพนักงาน <i class="fa-regular fa-user"></i></a>
                            ...
                            <div class="t-tb">
                                <div class="program">
                                    <a style="color:#338ac6;font-weight: bolder;">ทั้งหมด <div class="bug">11</div></a>
                                    <a href="doc-waitingApprov-OT.php">โอที<div class="bug" style="top: 38px;">9</div></a>
                                    <a href="doc-waitingApprov-LW.php">ลางาน<div class="bug" style="top: 72px;">7</div></a>
                                    <a href="doc-waitingApprov-WS.php">กะการทำงาน<div class="bug" style="top: 106px;">5</div></a>
                                    <a href="doc-waitingApprov-DO.php">วันหยุด<div class="bug" style="top: 140px;">3</div></a>
                                </div>
                                ...
                                <table class="data-table table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        <tr class="feth" style="background-color: #54B3D4;">
                                            <td><input type="checkbox"></td>
                                            <td colspan="3" style="font-size: 18px; color: #616061;"><h6>SCG120819 : นางสาววิจิตรา แซ่เอีย</h6></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td>ยื่นขอ "ลากิจได้รับค่าจ้างงาน"</td>
                                            <td>รออนุมัติ...</td>
                                            <td id="approv-child">
                                        ...
                                        <tr class="feth" style="background-color: #54B3D4;">
                                            <td><input type="checkbox"></td>
                                            <td colspan="3" style="font-size: 18px; color: #616061;"><h6>SCG234963 : นางสาวภัทราวดี ละมูลสุข</h6></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td>ยื่นขอ "ทำงานล่วงเวลา"</td>
                                            <td>รออนุมัติ...</td>
                                            <td>
                                                <div id="approv-child">
                                                    <button id="approv1-child"><i class="fa-solid fa-check"></i>อนุมัติ</button>
