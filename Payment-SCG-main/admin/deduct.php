        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                ...
                <div class="page-header">
                        ...
                        <div class="col-lg-12 col-md- 12-sm-12 mt-2">
                            <div class="card-box pd-30 pt-10 height-100-p" style="box-shadow:1px 4px 8px rgba(0, 0, 0, 0.2);">
                                <div class="pd-10">
                                    <div class="title">
                                        <div class="row">
                                            <h4 class="col-7">รายการเงินจ่าย: Deduct Payment</h4>
                                            <div class="col-3"></div>
                                            <div class="text-right col-2">
                                                <button onclick="openInsert_Deduct_Target_Modal()" type="button" class="btn setting-btn-pay" data-dismiss="modal">
                                                    + เพิ่มรายการจ่าย
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="pb-10">
                                    <table class="data-table2 table stripe hover nowrap">
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = deduct_target.card_id
                                        LEFT JOIN pl ON pl.pl_id = pl_info.pl_id 
                                        LEFT JOIN position_info ON position_info.card_id  = deduct_target.card_id
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertdeduct_targetModal" tabindex="-1" role="dialog" aria-labelledby="insertdeduct_targetModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">บันทึกรายการจ่าย</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="deduct.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <h6><label>ประเภทรายจ่าย</label></h6>
                                            <select id="deduct_typeDropdown" name="deduct_type_id" class="custom-select col-12" required="true" autocomplete="off">
                                                <option value="" disabled selected>เลือกประเภทรายจ่าย</option>
                                                <?php
                                                $sqlDropdown_type = "SELECT * FROM deduct_type";
                                                ...
                                                if ($resultDropdown_type) {
                                                    while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                        echo "<option value='" . $row['deduct_type_id'] . "'>" . $row['deduct_type'] . "</option>";
                                                    }
                                                }
                                                ?>
                                            </select>
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // คำสั่ง SQL สำหรับ Insert ข้อมูลเมื่อ card_id และ ทั้งหมด ว่าง
                                                        $sqlMerge = "MERGE INTO deduct_target AS target
                                                                USING (
                                                                ...
                                                                ) AS source (deduct_type_id,amount,whole_year_id,reason ,active,evidence_name,evidence_data, card_id)
                                                                ON target.card_id = source.card_id AND target.deduct_type_id = source.deduct_type_id
                                                                WHEN MATCHED THEN
                                                                    UPDATE SET  target.deduct_type_id = source.deduct_type_id,
                                                                ...
                                                                WHEN NOT MATCHED THEN
                                                                    INSERT (deduct_type_id,amount,whole_year_id,reason,active, evidence_name, evidence_data,card_id) 
                                                                    VALUES (source.deduct_type_id, source.amount, source.whole_year_id,source.reason,source.active,source.evidence_name, source.evidence_data, source.card_id);";

                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $contract_type_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $contract_type_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $contract_type_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $contract_type_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $contract_type_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $contract_type_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $contract_type_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $pl_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $position_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $contract_type_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $contract_type_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $contract_type_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $contract_type_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $contract_type_id, $pl_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $contract_type_id, $pl_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $contract_type_id, $pl_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $contract_type_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $contract_type_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $contract_type_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $contract_type_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $contract_type_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $contract_type_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $contract_type_id, $position_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $pl_id, $position_id);
                                                ...
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $contract_type_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id, $contract_type_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id, $contract_type_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id, $contract_type_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id, $contract_type_id, $pl_id, $position_id);
                                                    ...
                                                    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                                        ...
                                                        // กำหนดค่าพารามิเตอร์
                                                        $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile);
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $company_id);
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $company_id);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $division_id);
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $division_id);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $department_id);
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $department_id);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $section_id);
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $section_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                ...
                                                VALUES (source.deduct_type_id, source.amount, source.whole_year_id,source.reason,source.active,source.evidence_name, source.evidence_data, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, $filename, $targetFile, $cost_center_id);
                                                ...
                                                WHEN MATCHED THEN
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $active, null, null, $cost_center_id);
                                                ...
                                                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                                                    ...
                                                    $sqlMerge = "MERGE INTO deduct_target AS target
                                                            USING (
                                                                VALUES (?,?,?,?,?,?,?,?)
                                                            ) AS source (deduct_type_id,amount,whole_year_id,reason, card_id ,active,evidence_name,evidence_data)
                                                            ON target.card_id = source.card_id AND target.deduct_type_id = source.deduct_type_id
                                                            WHEN MATCHED THEN
                                                                UPDATE SET target.deduct_type_id = source.deduct_type_id,
                                                                           target.amount = source.amount,
                                                                           ...
                                                                           target.evidence_data = source.evidence_data
                                                            WHEN NOT MATCHED THEN
                                                                INSERT (deduct_type_id,amount,whole_year_id,reason, card_id,active, evidence_name, evidence_data) 
                                                                VALUES (source.deduct_type_id, source.amount, source.whole_year_id,source.reason, source.card_id,source.active,source.evidence_name, source.evidence_data);";

                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $card_id, $active, $filename, $targetFile);
                                                 ...
                                                 USING (
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($deduct_type_id, $amount, $whole_year_id, $reason, $card_id, $active, null, null);
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="editdeduct_targetModal" tabindex="-1" role="dialog" aria-labelledby="editdeduct_targetModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                    ...
                                    <form id="editForm" method="post" action="deduct.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group d-flex">
                                                <div class="mt-2 col-5">
                                                    <h6><label for="editdeduct_type">ประเภทรายจ่าย :</label></h6>
                                                </div>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="text" id="editdeduct_type" class="col-12" name="deduct_type" autocomplete="off" disabled style="border: none; background-color: transparent;">
                                            </div>
                                        </div>
                                        <h6><label>Organization</label></h6>
                                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="text-right mt-3">
                                                <button type="submit" class="btn btn-primary" name="update_deduct_target">บันทึกการแก้ไข</button>
                                            </div>
                                    </form>
