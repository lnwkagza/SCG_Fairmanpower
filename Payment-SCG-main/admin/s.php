                                ...
                                <div class="table-responsive mt-2">
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            INNER JOIN employee e ON e.card_id = log.card_id  
                                            INNER JOIN cost_center cc ON cc.cost_center_id = e.cost_center_organization_id 
                                            INNER JOIN section s ON s.section_id = cc.section_id 
                                            INNER JOIN department d ON d.department_id = s.department_id 
                                            INNER JOIN division d2 ON d2.division_id = d.division_id 
                                            INNER JOIN location l ON l.location_id = d2.location_id 
                                            INNER JOIN company c ON c.company_id = l.company_id 
                                            INNER JOIN contract_type ct ON ct.contract_type_id = e.contract_type_id 
                                            INNER JOIN pl_info On pl_info.card_id = e.card_id 
