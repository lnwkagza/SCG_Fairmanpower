        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">ตั้งค่าวันปิดงวด</li>
                ...
                <div class="row">
                                ...
                                <div class="title ">
                                    <div class="row">
                                        ...
                                        <div class="text-right col-3">
                                            <button onclick="openClosing_date_Setting_Modal()" type="button" class="btn insert-btn-pay" data-dismiss="modal">
                                                + เพิ่มการตั้งค่าวันปิดงวด
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="pb-10">
                                <table class="data-table2 table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        LEFT JOIN pl_info ON pl_info.card_id  = closing_date.card_id
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="insertclosing_dateModal" tabindex="-1" role="dialog" aria-labelledby="insertclosing_dateModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="text-light-green">
                                        <h4><label>+ เพิ่มการตั้งค่าวันปิดงวด </label></h4>
                                    </div>
                                </div>
                                <div class="modal-body">
                                    <h6>วันปิดงวด</h6>
                                    <form method="post" action="setting_payment_set_closing_date.php">
                                        <section>
                                            <div class="col-md-7 col-sm-7">
                                                <div class="form-group pt-1">
                                                    <select id="closing_date_setDropdown" name="closing_date_set_id" class="custom-select" required="true" autocomplete="off">
                                                        <option value="" disabled selected>เลือกวันปิดงวด</option>
                                                        <?php
                                                        ...
                                                        if ($resultDropdown_type) {
                                                            while ($row = sqlsrv_fetch_array($resultDropdown_type, SQLSRV_FETCH_ASSOC)) {
                                                                $closing_date_setValue = ($row['closing_date'] == 0) ? 'อัตโนมัติ' : 'กำหนดเอง';
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        if (isset($_POST['submit'])) {
                                            $closing_date_set_id = $_POST['closing_date_set_id'];
                                            ...
                                            if ((empty($card_id)) && (isset($contract_type_id))  && (empty($pl_id))  && (empty($position_id))) {
                                                if ((empty($company_id)) && (empty($division_id)) && (empty($department_id)) && (empty($section_id)) && (empty($cost_center_id))) {
                                                    ...
                                                    $sqlMerge = "MERGE INTO closing_date AS target
                                            USING (
                                            ...
                                            ) AS source (closing_date_set_id, card_id)
                                            ON target.card_id = source.card_id
                                            WHEN MATCHED THEN
                                                UPDATE SET target.closing_date_set_id = source.closing_date_set_id
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";

                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $contract_type_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment,  $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment,  $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $contract_type_id, $pl_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $contract_type_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessioncompany, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondivision, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessiondepartment, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $sessionsection, $contract_type_id, $pl_id, $position_id);
                                            ...
                                            WHEN NOT MATCHED THEN
                                                INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                    ...
                                                    // กำหนดค่าพารามิเตอร์
                                                    $params = array($closing_date_set_id, $cost_center_id, $contract_type_id, $pl_id, $position_id);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $sessioncompany);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $sessiondivision);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $sessiondepartment);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $sessionsection);
                                        ...
                                        WHEN NOT MATCHED THEN
                                            INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $cost_center_id);
                                         ...
                                         WHEN NOT MATCHED THEN
                                             INSERT (closing_date_set_id, card_id) VALUES (source.closing_date_set_id, source.card_id);";
                                                ...
                                                // กำหนดค่าพารามิเตอร์
                                                $params = array($closing_date_set_id, $card_id);
                                            ...
                                            Toast.fire({
                                                icon: "success",
                                                title: "บันทึกข้อมูลวันปิดงวดสำเร็จ"
                                            });            
                                            </script>';
                    ...
                    <!-- Modal Start -->
                    <div class="modal fade" id="editclosing_dateModal" tabindex="-1" role="dialog" aria-labelledby="editclosing_dateModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">แก้ไขวันปิดงวด</h5>
                                </div>
                                <div class="modal-body">
                                    <!-- Form for editing data -->
                                    <form id="editForm" method="post" action="setting_payment_set_closing_date.php">
                                        <input type="hidden" id="closing_date_id" name="closing_date_id">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="update_closing_date">บันทึกการแก้ไข</button>
                                        </div>
                                    </form>
                                    ...
                                    if (isset($_POST['update_closing_date'])) {
                                        $closing_date_id  = $_POST['closing_date_id'];
                                        $closing_date_set_id = $_POST['closing_date_set_id'];

                                        // อัปเดตค่าของฟิลด์ income_type
                                        $sqlUpdate = "UPDATE closing_date SET closing_date_set_id = '$closing_date_set_id' WHERE closing_date_id = '$closing_date_id'";
